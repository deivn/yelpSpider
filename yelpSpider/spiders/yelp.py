...
class YelpSpider(scrapy.Spider):
    ...
    offset = 710
    start_urls = ['https://www.yelp.com/search?find_desc=Roof%20Repair&find_loc=New%20York%2C%20NY&start='+str(offset)]
    ...
    def parse(self, response):
        ...
        if self.offset <= 99*10:
            self.offset += 10
            yield scrapy.Request('https://www.yelp.com/search?find_desc=Roof%20Repair&find_loc=New%20York%2C%20NY&start='+ str(self.offset), callback=self.parse)
